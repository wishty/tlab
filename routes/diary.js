...
var bodyParser = require('body-parser'); //body의 json을 파싱해주는모듈

var dateFormat = require('dateformat'); //날짜형식을 원하는 형태로바꿔주는 모듈
var empty = require('is-empty'); //빈값 체크 모듈 *.주의:0도empty로 판단함
